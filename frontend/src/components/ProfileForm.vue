  ...
  <div>
    ...
    <div v-if="activeTab === 'security'">
      <div class="bg-white rounded-xl shadow-sm p-6 max-w-full">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Postavke sigurnosti</h3>
        <p class="text-sm text-gray-500">Ovdje možete promijeniti lozinku i ostale sigurnosne postavke.</p>
      </div>
    </div>
  </div>
</template>
